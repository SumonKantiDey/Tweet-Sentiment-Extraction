...
# LOGGER's
LOGGER_DEBUG_FILE = '/content/drive/My Drive/sumon/tweet_sentiment_extarction/src/logs/debug.log'
LOGGER_INFO_FILE = '/content/drive/My Drive/sumon/tweet_sentiment_extarction/src/logs/info.log'
LOGGER_ERROR_FILE = '/content/drive/My Drive/sumon/tweet_sentiment_extarction/src/logs/error.log'
